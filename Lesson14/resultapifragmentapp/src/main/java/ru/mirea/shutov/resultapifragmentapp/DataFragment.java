package ru.mirea.shutov.resultapifragmentapp;
...
public class DataFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        button.setOnClickListener(v -> {
            ...
            result.putString(MyBottomSheetFragment.BUNDLE_KEY, dataToSend);
            ...
            getChildFragmentManager().setFragmentResult(MyBottomSheetFragment.REQUEST_KEY, result);
        });
    }
}